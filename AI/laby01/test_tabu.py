...
from utils import get_time_in_seconds, format_time
...
def sample_data():
    return pd.DataFrame(
        {
            "start_stop": ["StationA", "StationB", "StationC", "StationA", "StationB", "StationC"],
            "end_stop": ["StationB", "StationC", "StationA", "StationC", "StationA", "StationB"],
            ...
            "departure_time": ["08:00:00", "08:30:00", "09:00:00", "08:15:00", "08:45:00", "09:15:00"],
            "arrival_time": ["08:20:00", "08:50:00", "09:20:00", "08:35:00", "09:05:00", "09:35:00"],
        }
    )
...
def complex_data():
    return pd.DataFrame(
        {
            "start_stop": [
                "StationA", "StationA", "StationB", "StationB", "StationC", 
                "StationC", "StationD", "StationD", "StationE"
            ],
            "end_stop": [
                "StationB", "StationC", "StationC", "StationD", "StationD", 
                "StationE", "StationE", "StationA", "StationA"
            ],
            ...
            "line": ["Line1", "Line1", "Line2", "Line2", "Line3", "Line3", "Line4", "Line4", "Line5"],
            "departure_time": [
                "08:00:00", "08:05:00", "08:30:00", "08:35:00", "09:00:00", 
                "09:05:00", "09:30:00", "09:35:00", "10:00:00"
            ],
            "arrival_time": [
                "08:20:00", "08:25:00", "08:50:00", "08:55:00", "09:20:00", 
                "09:25:00", "09:50:00", "09:55:00", "10:20:00"
            ],
        }
    )
...
def test_time_vs_transfers_optimization(complex_data):
    ...
    if time_actual_time != transfers_actual_time and time_actual_transfers != transfers_actual_transfers:
        assert time_actual_time <= transfers_actual_time or transfers_actual_transfers <= time_actual_transfers
...
def test_with_real_data():
    ...
    try:
        ...
        stations_to_visit = random.sample(all_stations[1:], min(2, len(all_stations) - 1))
